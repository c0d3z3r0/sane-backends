...
typedef const struct hp_data_info_s *	HpDataInfo;
...
static hp_bool_t
_cenable_incolor (HpChoice this, HpOptSet optset, HpData data,
                  const HpDeviceInfo *info)
{
...
static hp_bool_t
_cenable_notcolor (HpChoice this, HpOptSet optset, HpData data,
                   const HpDeviceInfo *info)
{
  return sanei_hp_optset_scanmode(optset, data) != HP_SCANMODE_COLOR;
}
...
static SANE_Status
_probe_resolution (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
...
static SANE_Status
_probe_bool (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  HpScl		scl	= this->descriptor->scl_command;
  int		val	= 0;
...
_probe_choice (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  ...
  /* But they also support 30 bit. Dont rely on the inqure in this case */
  if (   (scl == SCL_DATA_WIDTH) && (maxval == 24)
...
static SANE_Status
_probe_each_choice (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  HpScl		scl	= this->descriptor->scl_command;
  int		minval, maxval, val;
  HpChoice	choices;
...
static SANE_Status
_probe_mirror_vert (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  ...
  {
    HpOption dwidth = hp_optset_get(optset, BIT_DEPTH);
    if (dwidth)
...
static SANE_Status
_probe_custom_gamma (_HpOption this, HpScsi scsi, HpOptSet optset,
                     HpData data)
{
 HpScl       scl = this->descriptor->scl_command;
...
static SANE_Status
_probe_devpix (_HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  HpScl	scl	= this->descriptor->scl_command;
  int	resolution;
...
static SANE_Status
_program_datawidth (HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  return hp_option_download(this, data, scsi);
}
...
static SANE_Status
_program_resolution (HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
...
static SANE_Status
_program_unload_after_scan (HpOption this, HpScsi scsi, HpOptSet optset,
                            HpData data)
{ HpDeviceInfo *info;
...
static SANE_Status
_program_change_doc (HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  int istat;
...
static SANE_Status
_program_calibrate (HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
  struct passwd *pw;
  SANE_Status status = SANE_STATUS_GOOD;
  size_t calib_size;
...
static SANE_Status
_program_ps_exposure_time (HpOption this, HpScsi scsi, HpOptSet optset,
                           HpData data)
{
    SANE_Status status = SANE_STATUS_GOOD;
    size_t calib_size = 0;
...
static SANE_Status
_program_mirror_horiz (HpOption this, HpScsi scsi, HpOptSet optset, HpData data)
{
...
static hp_bool_t
_enable_mono_map (HpOption this, HpOptSet optset, HpData data,
                  const HpDeviceInfo *info)
{
  HpOption 	cgam	= hp_optset_get(optset, CUSTOM_GAMMA);
...
static hp_bool_t
_enable_rgb_matrix (HpOption this, HpOptSet optset, HpData data,
                    const HpDeviceInfo *info)
{
...
static hp_bool_t
_enable_autoback (HpOption this, HpOptSet optset, HpData data,
                  const HpDeviceInfo *info)
{
...
static hp_bool_t
_enable_halftone (HpOption this, HpOptSet optset, HpData data,
                  const HpDeviceInfo *info)
{
...
static hp_bool_t
_enable_halftonevec (HpOption this, HpOptSet optset, HpData data,
                     const HpDeviceInfo *info)
{
...
static hp_bool_t
_enable_calibrate (HpOption this, HpOptSet optset, HpData data,
                   const HpDeviceInfo *info)
{
...
static const struct hp_option_descriptor_s MATRIX_RGB10[1] = {{
    ...
    REQUIRES(HP_COMPAT_5P | HP_COMPAT_5100C | HP_COMPAT_6200C
             | HP_COMPAT_5200C | HP_COMPAT_6300C),
    _probe_matrix, 0, _enable_rgb_matrix,
    0, 0, 0, 0, 0, SCL_10x9MATRIX_COEFF
}};
#endif
...
static const struct hp_option_descriptor_s BWMATRIX_GRAY10[1] = {{
    ...
    0, 0, 0, 0, 0, SCL_10x3MATRIX_COEFF
}};
#endif
...
static const struct hp_choice_s _data_widths[] = {
    {1, "1"}, {24, "8"}, {30, "10"}, {36, "12"}, {42, "14"}, {48, "16"},
    {0, 0}
};
...
static const struct hp_option_descriptor_s BIT_DEPTH[1] = {{
    ...
    NO_REQUIRES,
    _probe_choice, _program_datawidth, _enable_datawidth,
...
static SANE_Status
hp_optset_fix_geometry_options (HpOptSet this, HpDevice dev)
{
  ...
  {HpOption option;
   ...
   if ( option )
   {
     ...
     if ( is_preview )
     {
       ...
       {
         option = hp_optset_get(this, BIT_DEPTH);
         if (option)
         {
           data_width = hp_option_getint (option, data);
           if (data_width > 24)
           {
...
sanei_hp_optset_new(HpOptSet * newp, HpScsi scsi, HpDevice dev)
{
  ...
  status = hp_optset_fix_geometry_options(this, dev);
  if (FAILED(status))
    {
      sanei_hp_free(this);
      return status;
